...
export const metadata: Metadata = {
  title: "Render to AWS Migration Services | In-House DevOps Team",
  description:
    "Move off Render onto AWS, containers, managed databases, CI/CD, and a tested cutover plan. Delivered by our in-house DevOps team.",
};

const WHAT_WE_DO_ITEMS = [
  {
    title: "Migration assessment",
    line: "A review of your current Render setup, services, databases, and environment variables, before planning the move.",
  },
  {
  ...
  },
  {
    ...
    line: "Move your database to RDS or another managed AWS option.",
  },
  {
    title: "CI/CD rebuild",
    line: "Replace Render's build/deploy flow with a CI/CD pipeline suited to AWS.",
  },
];
...
const OUTCOMES = [
  ...
  "More infrastructure control than Render's platform offers",
...
const FAQS: ServiceFaqItem[] = [
  {
    question: "Why move off Render?",
    answer:
      "Common reasons include cost at scale, needing more infrastructure control, or requiring AWS-specific services, we'll help confirm it's the right move for your situation.",
  },
  {
...
const SERVICE_JSON_LD = {
  ...
  "@type": "Service",
  name: "Render to AWS Migration Services",
  serviceType: "Render to AWS Migration",
  provider: {
    "@type": "Organization",
...
export default function RenderToAwsMigrationServicesPage() {
  return (
    <>
      ...
      <ServiceHero
        eyebrow="Render to AWS Migration Services"
        title="Render to AWS Migration Services"
        subtitle="Move off Render onto AWS, containers, managed databases, CI/CD, and a tested cutover plan. Delivered by our in-house team."
      ...
      <ProblemValue
        heading="When you've outgrown Render"
        points={[
          "Render costs have grown faster than expected at scale.",
          "You need more control over infrastructure than Render's platform allows.",
          "You need AWS-specific services that Render doesn't offer.",
          "You want a documented plan, not a risky, improvised move.",
        ]}
        closingLine="We plan the migration path before touching your production Render app."
      />
      ...
      <ServiceFAQ id="faq" heading="Questions about migrating from Render to AWS" faqs={FAQS} />
