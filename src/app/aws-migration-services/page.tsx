...
export const metadata: Metadata = {
  title: "AWS Migration Services | In-House DevOps Team",
  description:
    "Move applications, databases, and infrastructure onto AWS, with a documented plan for cutover, not guesswork. Delivered by our in-house DevOps team.",
};
...
const WHAT_WE_DO_ITEMS = [
  ...
  },
  {
    ...
    line: "Move applications onto AWS, containerised or not.",
  },
  {
  ...
  },
  {
    ...
    line: "The new AWS environment defined as code from day one.",
...
const OUTCOMES = [
  ...
  "Infrastructure defined as code from day one on AWS",
...
const FAQS: ServiceFaqItem[] = [
  ...
  },
  {
    ...
    answer:
      "Any platform, another cloud, on-premises infrastructure, or a platform like Heroku. See our source-platform migration pages for specific scenarios.",
  },
  {
...
export default function AwsMigrationServicesPage() {
  return (
    <>
      ...
      <ServiceHero
        eyebrow="AWS Migration Services"
        title="AWS Migration Services"
        subtitle="Move applications, databases, and infrastructure onto AWS, with a documented plan for cutover, not guesswork. Delivered by our in-house team."
        primaryCta={{ label: "Book a DevOps consultation", href: "/contact/" }}
        secondaryCta={{ label: "What migration involves", href: "#what" }}
      />

      <ProblemValue
        heading="When you need to migrate to AWS"
        points={[
          "You've outgrown your current hosting platform.",
          "You need AWS specifically, for cost, compliance, or ecosystem reasons.",
      ...
      <ServiceFAQ id="faq" heading="Questions about AWS migration" faqs={FAQS} />
